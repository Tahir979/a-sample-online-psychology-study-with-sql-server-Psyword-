...
namespace DEMO
{
    class gereklikodlar
    {
        ...
        /*
                ...
                void ilkasama()
        {
            lbl_toplananpuan.Invoke((MethodInvoker)(() => lbl_toplananpuan.Visible = false));
            lbl_kelimepuan.Invoke((MethodInvoker)(() => lbl_kelimepuan.Visible = false));
            label2.Invoke((MethodInvoker)(() => label2.Visible = false));
            lsl_soru.Invoke((MethodInvoker)(() => lsl_soru.Visible = false));
            progres_beyaz.Invoke((MethodInvoker)(() => progres_beyaz.Visible = false));
