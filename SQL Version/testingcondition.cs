...
namespace DEMO
{
    public partial class testingcondition : Form
    {
        ...
        int kelimesayac = 0, kelimeindex = 0, oturum, sayyy = 0, sorusayi = 1, bitti = 0;
        string kullaniciadi, kullanicigrup, ifade, timestamp, basla, bitir, girisdatetime, anlamli_RT_95, j, dogruidtotal, yanlisidtotal;
        ...
        private void label_Click(object sender, EventArgs e)
        {
            ...
            else if (((Label)sender).Name.ToString() == "question24")
            {
                if (lbl24 == 1)
                {
        ...
        void kelimeekle()
        {
            ...
            kelimeler_soru.Add(gridwords.Rows[0].Cells[3].Value.ToString());
            kelimeler_id.Add(Convert.ToInt32(gridwords.Rows[0].Cells[5].Value.ToString()));
            font.Add(Convert.ToInt32(gridwords.Rows[0].Cells[7].Value));
        }
        void yenisoru()
        {
            ...
            if (kelimesayac == 24)
            {
                ...
                if (NetworkInterface.GetIsNetworkAvailable() == true)
                {
                    ...
                    cmd_sql = new SqlCommand("ekleSinamaGroup", con_sql)
                    {
